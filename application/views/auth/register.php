                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        <div class="form-group label-floating has-success">
                            ...
                            <input name="username" type="text" placeholder="Yuninda Eka" class="form-control" required />
                        </div>
                        <div class="form-group label-floating has-success">
                            <label class="control-label">Email</label>
                            <input name="email" type="email" placeholder="yunindae@mail.com" class="form-control" required />
                        </div>
                        <div class="form-group label-floating has-success">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="<?php echo base_url('login') ?>" class="btn btn-secondary btn-block btn-lg">Login</a>
                            </div>
                            <div class="col-md-6">
